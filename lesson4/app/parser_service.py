...
def run_parser(base_url: str, username: str, password: str, headed: bool = False):
    ...
    try:
        ...
        # Сбор трафика через performance логи.
