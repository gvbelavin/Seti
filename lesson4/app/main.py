...
app = FastAPI(title="Lesson4 Parser API")
...
def parse_url(
    ...
    try:
        quotes_data, stats = run_parser(url, username, password, headed=headed)
    ...
    return ParseResponse(
        message="Парсинг завершен, данные записаны в Postgres",
        source_url=url,
